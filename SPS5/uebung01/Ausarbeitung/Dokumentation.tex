...
Zur Implementierung gibt es zu erwähnen, dass in der selben Methode oft auf die gleichen Feldelemente zugegriffen wird. Hier wäre es vielleicht
...
\subsection{Wo wird die meiste Rechneleistung verbraucht?}
 ...
 Die Analsyse der Methode zeigt, dass sehr viele \texttt{Point} Objekte angelegt und dann sogar nochmals kopiert werden.
...
Die lokale Variable \texttt{neighbors} wurde als private Datenkomponente angelgt und wird so für jeden Aufruf wiederverwendet. Damit braucht sie nicht jedesmal neu angelegt werden.
...
\textbf{Speedup zur original Version:} 1,24726873\linebreak
...
\textbf{Speedup zur original Version:} 1,513643593\linebreak
...
\textbf{Speedup zur original Version:} 1,6427422
...
Standardabweichung           & 220,870269 & 31,7208145 & 41,3133005  & 28,9859302 \\ \midrule
														 &            &            &             &            \\
Speedup zur vorherigen Version   &           & 1,24726873 & 1,21160329  & 1,0852900  \\ \midrule
Speedup zur originalen Version &           & 1,24726873 & 1,513643593 & \textbf{1,6427422}  \\ \bottomrule
\end{tabular}
\end{table}
\end{document}