...
public class JPAWorkLogManagerOrig {
  ...
  public static void listEmployeesOfProject(Long projectId) {
    ...
    // Query qry =
    // em.createQuery("select e from Employee e where :proj in elements (e.projects)");
    // Query qry =
    // em.createQuery("select e from Employee e where :proj member of e.projects");
    TypedQuery<Employee> qry = em.createQuery("select e from Employee e, in (e.projects) p where p = :proj", Employee.class);
