...
Um die Liste der Züge vom Start bis zur aktuellen Konfiguration zu berechnen, muss die verkette Liste aufgelöst werden.\newline
...
\textbf{Ablauf:}
\begin{itemize}
	\item Zu Begin wird die Startkonfiguration in die \textbf{openQueue} eingefügt.
