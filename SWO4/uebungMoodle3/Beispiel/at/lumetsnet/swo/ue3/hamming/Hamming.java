package at.lumetsnet.swo.ue3.hamming;
...
public class Hamming {
  ...
  public static List<BigInteger> calculate(BigInteger upper) {
    ...
    // variables which point to the current
    // index to multiply with
    ...
    while (true) {
      ...
      // check all values against the current min
      // and increase the indexes if needed
