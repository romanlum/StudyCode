...
\begin{itemize}
\item Für den Heapsort wird zu Beginn das Eingabefeld in einen Heap übergeführt. Damit befindet sich das größte Element an erster Stelle.
\item Dieses wird dann mit dem letzten Element vertauscht und die Größe um 1 verringert.
...
\item Dies wird dann solange wiederholt bis die Heapgröße gleich 1 ist.
\end{itemize}
...
Weiters müssen die Algorithmen erweitert werden, damit sie die Daten zur Verfügung stellen. \newline
