...
public class MenuDaoTest extends GenericDaoTest {
	...
	public void insertTest() {
		...
		Menu entity = new Menu(-1,"desc",1000,LocalDate.now(),LocalDate.now().plusDays(100),null);
	...
	public void getAllTest() {
		...
		entity.setCategoryId(catId);
		dao.saveOrUpdate(entity);
		entity = new Menu(-1,"desc2",2000,LocalDate.now(),LocalDate.now().plusDays(100),null);
		entity.setCategoryId(catId);
