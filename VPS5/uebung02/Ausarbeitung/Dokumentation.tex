...
Abbildung~\ref{fig:SimpleRaceConditionFixed} zeigt die Ausgabe der verbesserten Version. Diese verwendet Locks um die race condition zu vermeiden.\linebreak
...
\subsubsection*{2a.}
Um nur 10 Dateien parallel herunterzuladen kann eine Semaphore verwendet werden, die die gleichzeitige Anzahl an Downloads auf maximal 10 reduziert.

\subsubsection*{2b.}
Um auf alle Threads zu warten müssen diese in einer Liste gespeichert um auf alle Threads durch den Aufruf der Methode \texttt{Join} zu warten.
...
Die Synchronisation wurde ebenfalls über die Warteschlange gelöst. Hier wurde ebenfalls das Interface \texttt{IQueue} um die Methode \texttt{TryDequeue} erweitert. Diese blockiert, falls aktuell kein Element vorhanden ist aber noch nicht alle Elemente hinzugefügt wurden.
...
Ø    & 196                                                               & 0,490      &  & 00:00:00.530 \\
Std. Abw.    & 83,750                                                               & 0,2092      &  & 00:00:00.361 \\ \cline{1-5}
...
Ø    & 36,6     	                                                          & 0,091      &  & 00:00:00.573 \\
Std. Abw.    & 3,029                                                               & 0,00995      &  & 00:00:00.288 \\ \cline{1-5}
