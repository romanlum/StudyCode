...
namespace VSS.ToiletSimulation
{
    public class Person : IJob
    {
        ...
        public DateTime LatestStartTime { get; private set; }
        ...
        public Person(Random random, string id)
        {
            ...
            NormalRandom processingTimeRandom = new NormalRandom(random, Parameters.MeanProcessingTime,
            ...
            LatestStartTime = DueDate.Subtract(ProcessingTime);
        }
