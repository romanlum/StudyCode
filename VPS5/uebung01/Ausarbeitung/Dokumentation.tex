...
Rechenleistung um die Objekte wieder aufzuräumen. Weiters muss für jeden Nachbar der Zeilen- und Spaltenindex berechnet und eine Typprüfung durchgeführt werden.
\begin{mdframed}
\begin{flushleft}
...
Damit wurde die Notwendigkeit von \texttt{Point} Objekten entfernt und alle Positionsangaben wurden auf \texttt{int} geändert. Dadurch gibt es bei der Bestimmung der Nachbarn keine Divisionen mehr.
