...
\subsection{Wo wird die meiste Rechenleistung verbraucht?}
 ...
 Die Analyse der Methode zeigt, dass sehr viele \texttt{Point} Objekte angelegt und dann sogar nochmals kopiert werden.
...
Da die Version 3 keinen großen Speedup gebracht hat, wurde eine erneute Optimierung vorgenommen. Diesmal wurde das Feld \texttt{Grid} von einem zweidimensionalen Feld auf ein eindimensionales Feld geändert.
Damit wurde die Notwendigkeit von \texttt{Point} Objekten entfernt und alle Positionsangaben wurden auf \texttt{int} geändert.
